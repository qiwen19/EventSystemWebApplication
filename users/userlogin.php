            ...
            <nav id="mainNav" class="navbar navbar-inverse navbar-custom navbar-fixed-top">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header page-scroll">
                        ...
                        <a class="navbar-brand page-scroll" href="../index.php"><img src="../img/logo.png" class="navlogo" alt="logo" /></a>
                    </div>
            ...
            <div class="col-lg-6 pull-right">
                <div class="panel panel-default panel-transparent">
                    <div class="panel-heading">
                        <span class="panel-title pull-left">Register/Sign In to JetArena</span>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <ul class="contact">
                            <span>SiteMap</span>    
                                ...
                                <li><a href="../games.php">Games</a></li>
                                <li><a href="../guilds.php">Guilds</a></li>
                                <li><a href="userlogin.php">Sign Up/Register</a></li>
                        </ul>
                    </div>
