                ...
                <div class="col-lg-9">
                    ...
                    <form>
                        ...
                        <div class="input-group form-group">
                            ...
                            <input type="text" class="form-control datepicker" name="bookdate" style="color: black;" value="<?php echo $now; ?>" required="required"/>
                        </div>
                        ...
                        <div class="form-group"> <!-- Subject field -->
                            ...
                            <input type="number" min="2" max="20" step="2" style="color: black;" />
                        </div>
