        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9">
                    ...
                    ?>
                    <form class="form-horizontal"  action="../includes/db/editAdminGuildHandle.php" enctype="multipart/form-data" method="post">
                        ...
                        <div class="col-xs-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="hidden" value="<?= $guildNumber ?>" name="guild_id">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-md-6">
                            <div class="form-group">
                                ...
                                <a href="adminguilds.php" class = "btn btn-default">Back</a>
                            </div>
                        </div>
                    </form>
                </div>
