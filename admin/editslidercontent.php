            ...
            <div class="row">
                <div class="panel panel-default panel-transparent">
                    <div class="panel-heading">
                        <span class="panel-title pull-left">Edit Slider Content</span>
                    ...
                    foreach ($slider as $sliderinfo){
                        ...
                        $image = $sliderinfo['slider_filename'];
                    }
                    ?>
                    <div class="col-lg-24">
                        <form class="form-horizontal"  action="editslidercontentHandle.php" method="post">
                            <div class="form-group">
                                <div class="col-lg-6">
                                    <label for="contact-name" class="control-label">Slider Title:</label>
                            ...
                            <div class="form-group">
                                <div class="col-lg-6">
                                    <label for="contact-name" class="control-label">Slider Description</label>
                            ...
                            <button type = "submit" class = "btn btn-default">Edit Slider</button>
                        </form>
                    </div>
                    </div>
                </div>
