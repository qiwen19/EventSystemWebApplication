            ...
            <div class="row">
                <div class="panel panel-default panel-transparent">
                    <div class="panel-heading">
                        <span class="panel-title pull-left"> Create a new slider</span>
                    ...
                    <div class="col-lg-24">
                        <form class="form-horizontal"  action="newslidercontentHandle.php" method="post" enctype="multipart/form-data">
