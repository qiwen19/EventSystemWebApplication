            ...
            <div class="row">
                <div class="panel panel-default panel-transparent">
                    <div class="panel-heading">
                        <span class="panel-title pull-left"> Change Password</span>
                    ...
                    <div class="col-lg-24">
                        <form class="form-horizontal" action="changePasswordHandle.php" method="post">
                            ...
                            <div class="form-group">
                                <div class="col-lg-6">
                                    <label for="contact-name" class="control-label">Old Password:</label>
                                    <input class="form-control" type="password" name="oldpassword" size="50" />
                                </div>
                            </div>

                            <div class="form-group">
                                <div class="col-lg-6">
                                    <label for="contact-name" class="control-label">New Password:</label>
                                    <input class="form-control" type="password" name="newpassword" size="50" />
                                </div>
                            </div> 
    
                            <div class="form-group">
                                <div class="col-lg-6">
                                    <label for="contact-name" class="control-label">Confirm New Password:</label>
                                    <input class="form-control" type="password" name="cfmnewpassword" size="50" />
                                 </div>
                            </div>
