...
if ($_FILES["myRules"]["error"] == 0) {
    ...
    //uploadFileHandle($currFile = null, $id = 0, $disDir = null);
    $rules_pdf = $uploadFilename;
    updateGamesInfoDraft($con,$ga_id,$ga_name,$ga_type,$date,$start,$end,$location,$description,$min_attendance,$rules_pdf,$updatedAt,$debug =false);
} else {
    updateGamesInfoNoPdfDraft($con,$ga_id,$ga_name,$ga_type,$date,$start,$end,$location,$description,$min_attendance,$session_urid,$updatedAt);
}
}
?>
